...
function makePStyles(c: Colors) {
  return StyleSheet.create({
    ...
    chartLabel: { fontSize: fontSize.sm, fontWeight: '700', textTransform: 'uppercase', letterSpacing: 0.5, flex: 1 },
    chartGoal: { fontSize: fontSize.sm, color: c.muted },
    pbLabel: { fontSize: fontSize.sm, color: c.text },
    pbValue: { fontSize: fontSize.sm, color: c.muted },
    ...
    metricUnit: { fontSize: fontSize.sm, color: c.muted },
    metricSub: { fontSize: fontSize.sm, color: c.muted, marginBottom: 2 },
    ...
    recordLabel: { fontSize: fontSize.sm, color: c.muted, textTransform: 'uppercase', letterSpacing: 0.5 },
    recordVal: { fontSize: fontSize.lg, fontWeight: '700', color: c.text },
    recordSub: { fontSize: fontSize.sm, color: c.muted, marginTop: 2 },
...
function makeSStyles(c: Colors) {
  return StyleSheet.create({
    ...
    cardDate: { flex: 1, fontSize: fontSize.sm, color: c.muted, textTransform: 'uppercase', letterSpacing: 0.5 },
    cardDuration: { fontSize: fontSize.sm, color: c.muted },
    cardName: { fontSize: fontSize.base, fontWeight: '600', color: c.text },
    cardStats: { fontSize: fontSize.sm, color: c.muted },
    cardExercises: { fontSize: fontSize.sm, color: c.border, marginTop: 2 },
...
function makeEStyles(c: Colors) {
  return StyleSheet.create({
    ...
    catText: { fontSize: fontSize.sm, color: c.muted },
...
function makeRpStyles(c: Colors) {
  return StyleSheet.create({
    ...
    sectionLabel: { textAlign: 'center', color: c.muted, fontSize: fontSize.sm, marginVertical: 4 },
    ...
    routineMeta: { fontSize: fontSize.sm, color: c.muted, marginTop: 2 },
