...
- **Goal values show two decimals** — the Goals tab, the goal detail history, the progress list and the weekly blurb all match the web precision, since they read the same shared formatter `0b7c6b8`
