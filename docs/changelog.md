...
- **Day event indicator nutrition label fix** — Removed "Custom targets" fallback label from the colored event dots in the calendar; nutrition schedules without day types now show only the dot indicator. `23b9b90`
