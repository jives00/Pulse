...
- **Deleted two dead dashboards** — `apps/web/src/pages/WorkoutsDashboardPage.tsx` (2,409 lines, imported nowhere) and mobile's unreachable `ProgressTab` plus the six helpers only it used (346 lines); the visible `/progress` route renders a different component `e153f46`
