...
- **Weekly goal progress learned which direction each goal points** — same directional pace ladder, water section in glasses, and weekly-column goal fallbacks, off the shared `weeklyPace` helper. Mobile keeps its vertical stack rather than the web card's equal-width row `9cd7226`
